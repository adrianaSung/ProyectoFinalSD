...
class StudentServiceImplTest {
    ...
    void testSuccessModifyStudent() {
        ...
        Student student = service.modifyStudent("Daniel","Sanchez","Forensic Science",subjects);

        assertEquals("Forensic Science", student.getUniversityDegree());
    }
}