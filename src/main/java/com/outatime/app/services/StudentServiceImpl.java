...
import com.outatime.app.exceptions.*;
...
public class StudentServiceImpl implements IStudentService{
    ...
    /*
    Method to create a Student. If Student is not found, the exception will appear
     */
    @Override
    ...
    /*
    Method to modify a Student's universityDegree or subjects. If Student is not found, the exception will appear
     */
    @Override
    public Student modifyStudent(String name, String surname, String universityDegree, List<Subject> subjects) {
        Random randomId = new Random();
        ...
        try {
            ...
            if(studentOptional.isPresent()){
                ...
                List<Subject> mySubjects = this.subjectRepository.getMySubjects();
                myStudent = new Student(name, surname, universityDegree, randomId.nextLong());
